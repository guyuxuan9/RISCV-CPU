...
void Vfullcpu___024root__trace_chg_sub_0(Vfullcpu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgBit(oldp+6,((1U & vlSelf->fullcpu__DOT__blue__DOT__A)));
        bufp->chgBit(oldp+7,(vlSelf->fullcpu__DOT__jalmuxSel));
        bufp->chgIData(oldp+8,(vlSelf->fullcpu__DOT__blue__DOT__A),32);
        bufp->chgCData(oldp+9,((0x7fU & vlSelf->fullcpu__DOT__Instr)),7);
        bufp->chgCData(oldp+10,((7U & (vlSelf->fullcpu__DOT__Instr 
                                       >> 0xcU))),4);
        bufp->chgBit(oldp+11,((1U & (vlSelf->fullcpu__DOT__Instr 
                                     >> 0x1eU))));
        bufp->chgCData(oldp+12,((0x1fU & (vlSelf->fullcpu__DOT__Instr 
                                          >> 0xfU))),5);
        bufp->chgCData(oldp+13,((0x1fU & (vlSelf->fullcpu__DOT__Instr 
                                          >> 0x14U))),5);
        bufp->chgCData(oldp+14,((0x1fU & (vlSelf->fullcpu__DOT__Instr 
                                          >> 7U))),5);
        bufp->chgQData(oldp+15,((QData)((IData)((1U 
                                                 & vlSelf->fullcpu__DOT__blue__DOT__A)))),33);
        bufp->chgIData(oldp+17,(vlSelf->fullcpu__DOT__topregalu__DOT__ALUop1),32);
        ...
        bufp->chgIData(oldp+51,(((IData)(4U) + (IData)((QData)((IData)(
                                                                       (1U 
