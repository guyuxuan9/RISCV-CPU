...
VL_ATTR_COLD void Vfullcpu___024root__trace_init_sub__TOP__0(Vfullcpu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+11,"funct3", false,-1, 3,0);
    ...
    tracep->declBus(c+3,"ALUCtrl", false,-1, 2,0);
    tracep->declBus(c+54,"ImmOp", false,-1, 31,0);
    tracep->declQuad(c+16,"PC", false,-1, 32,0);
    tracep->declBit(c+8,"jalmuxSel", false,-1);
    ...
    tracep->declBus(c+63,"Results", false,-1, 31,0);
    tracep->declBus(c+64,"jalmuxOut", false,-1, 31,0);
    tracep->pushNamePrefix("ALU ");
    tracep->declBus(c+65,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+18,"ALUSrcA", false,-1, 31,0);
    ...
    tracep->declBus(c+65,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBit(c+59,"clk", false,-1);
    tracep->declBus(c+13,"A1", false,-1, 4,0);
    tracep->declBus(c+14,"A2", false,-1, 4,0);
    tracep->declBus(c+15,"A3", false,-1, 4,0);
    ...
    tracep->declBus(c+62,"RD", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("jalmux ");
    tracep->declBus(c+65,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+63,"d0", false,-1, 31,0);
...
VL_ATTR_COLD void Vfullcpu___024root__trace_full_sub_0(Vfullcpu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+7,((1U & vlSelf->fullcpu__DOT__blue__DOT__A)));
    bufp->fullBit(oldp+8,(vlSelf->fullcpu__DOT__jalmuxSel));
    bufp->fullIData(oldp+9,(vlSelf->fullcpu__DOT__blue__DOT__A),32);
    bufp->fullCData(oldp+10,((0x7fU & vlSelf->fullcpu__DOT__Instr)),7);
    bufp->fullCData(oldp+11,((7U & (vlSelf->fullcpu__DOT__Instr 
                                    >> 0xcU))),4);
    bufp->fullBit(oldp+12,((1U & (vlSelf->fullcpu__DOT__Instr 
                                  >> 0x1eU))));
    bufp->fullCData(oldp+13,((0x1fU & (vlSelf->fullcpu__DOT__Instr 
                                       >> 0xfU))),5);
    bufp->fullCData(oldp+14,((0x1fU & (vlSelf->fullcpu__DOT__Instr 
                                       >> 0x14U))),5);
    bufp->fullCData(oldp+15,((0x1fU & (vlSelf->fullcpu__DOT__Instr 
                                       >> 7U))),5);
    bufp->fullQData(oldp+16,((QData)((IData)((1U & vlSelf->fullcpu__DOT__blue__DOT__A)))),33);
    bufp->fullIData(oldp+18,(vlSelf->fullcpu__DOT__topregalu__DOT__ALUop1),32);
    ...
    bufp->fullIData(oldp+52,(((IData)(4U) + (IData)((QData)((IData)(
                                                                    (1U 
                                                                     & vlSelf->fullcpu__DOT__blue__DOT__A)))))),32);
    ...
    bufp->fullIData(oldp+62,(vlSelf->fullcpu__DOT__topregalu__DOT__datamemory__DOT__ram_array
                             [(0xffU & vlSelf->fullcpu__DOT__topregalu__DOT__ALUout)]),32);
    bufp->fullIData(oldp+63,(((IData)(vlSelf->fullcpu__DOT__ResultSrc)
    ...
    bufp->fullIData(oldp+64,(((IData)(vlSelf->fullcpu__DOT__jalmuxSel)
                               ? ((IData)(4U) + (IData)((QData)((IData)(
                                                                        (1U 
